...
try{
  ...
  await guest.keyboard.press('ArrowDown',{delay:180});
  ...
  await host.bringToFront();await host.waitForFunction(()=>!document.hidden);await host.locator('#screen').focus();await host.keyboard.press('ArrowDown',{delay:250});
